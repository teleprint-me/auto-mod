...
function wikitext_103_raw_v1() {
    ...
    declare -A WIKI_MAP=(
        ...
        ["train_1"]='https://huggingface.co/datasets/Salesforce/wikitext/resolve/main/wikitext-103-raw-v1/train-00000-of-00002.parquet?download=true'
        ["train_2"]='https://huggingface.co/datasets/Salesforce/wikitext/resolve/main/wikitext-103-raw-v1/train-00001-of-00002.parquet?download=true'
    ...
    declare -A OUTPUT_MAP=(
        ["test"]="${WIKI_PATH}/test-00000-of-00001.parquet"
        ["train_1"]="${WIKI_PATH}/train-00000-of-00002.parquet"
        ["train_2"]="${WIKI_PATH}/train-00000-of-00002.parquet"
        ["validation"]="${WIKI_PATH}/validation-00000-of-00001.parquet"
    )
