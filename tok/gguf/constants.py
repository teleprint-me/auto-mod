...
TENSOR_NAMES: dict[GGUF_MODEL_TENSOR, str] = {
...
MODEL_TENSORS: dict[GGUF_MODEL_ARCH, list[GGUF_MODEL_TENSOR]] = {
...
MODEL_TENSOR_SKIP: dict[GGUF_MODEL_ARCH, list[GGUF_MODEL_TENSOR]] = {
    GGUF_MODEL_ARCH.LLAMA: [
        GGUF_MODEL_TENSOR.ROPE_FREQS,
        GGUF_MODEL_TENSOR.ATTN_ROT_EMBD,
    ],
